package org.survey.config.audit;
...
import org.survey.domain.AbstractAuditingEntity;
import org.survey.domain.EntityAuditEvent;
import org.survey.repository.EntityAuditEventRepository;
...
public class AsyncEntityAuditEventWriter {
    ...
    private EntityAuditEvent prepareAuditEntity(final Object entity, EntityAuditAction action) {
        ...
        /*if(abstractAuditEntity.getIpAddress()==null)
        {
        abstractAuditEntity.setIpAddress("127.0.0.1");
        }*/
